    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_book_catalogues", x => x.BookCatalogueId);
                    table.ForeignKey(
                        name: "FK_book_catalogues_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_book_catalogues_Catalogues_CatalogueId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cart_details", x => x.CartDetailId);
                    table.ForeignKey(
                        name: "FK_cart_details_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_book_catalogues_BookId",
                table: "book_catalogues",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_book_catalogues_CatalogueId",
                table: "book_catalogues",
                column: "CatalogueId");
